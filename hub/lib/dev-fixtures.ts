...
export const MOCK_NOTIFICATION_PREFS = [
  ...
  {
    event_type: "description_uploaded",
  ...
  {
    event_type: "storyboard_uploaded",
...
export const MOCK_SHOOTS: Shoot[] = [
  // 1) Upcoming shoot — pristine, all not_present
  {
    ...
    male_talent: "Danny Steele",
    male_agency: "101 Modeling",
    male_rate: "$900",
    male_payment_name: "Daniel Steele",
    destination: "",
    location: "",
    home_owner: "David",
    ...
    scenes: [
      {
        ...
        position: 1,
        title: "",
        performers: "Sophia Locke / Danny Steele",
        has_thumbnail: false,
