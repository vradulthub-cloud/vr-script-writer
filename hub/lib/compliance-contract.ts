 ...
 *
 * Mirrored from api/compliance_contract.py — that file is the source of truth.
 * Run `pytest tests/test_contract_parity.py` to verify the two stay in sync.
 *
 * Typos preserved verbatim as they appear in the legacy PDFs:
 *   - "Servics" (Section 1)
 *   - "<YOUR JURISDICTION>" (Section 11)
 *   - '("ICCC)' (Section 11) — missing close-quote
 *   - "operator received" (Indemnity) — lowercase
 */
...
export const CONTRACT_TITLE = "Model Services Agreement and Release"
...
export const AGREEMENT_SECTIONS: readonly ContractSection[] = [
  {
    id: "services",
    heading: "1. Services",
    body:
...
export const WITNESS_STATEMENT =
...
export const DOCUMENTS_PROVIDED_HEADING =
  "I HEREBY AM PROVIDING THE FOLLOWING DOCUMENTS CONCURRENTLY HEREWITH:"

export const DOCUMENTS_PROVIDED_LIST: readonly string[] = [
...
export const PERJURY_STATEMENT =
...
export const PRODUCER_NAME = "Eclatech LLC"
